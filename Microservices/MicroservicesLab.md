...
- **이전 연구실**에서 로컬 컴퓨터의 IDE 환경 및 GIT 클라이언트. 지침에서는 로컬 호스트 컴퓨터에서 대괄호 편집기를 사용한다고 가정합니다.**Brackets Editor 설치에 대한 자세한 내용은 이전 연구**에서 다루 었으며 [here](../Java%20Apps/brackets.md)을 찾을 수도 있습니다. 
...
1. 대괄호 텍스트 편집기를 시작하려면**대괄호**바탕 화면 아이콘, [시작] 메뉴 단추 또는 해당 컴퓨터의 바로 가기를 두 번 클릭하십시오. 
...
1. 대괄호로 server.js 파일을 엽니 다 (더블 클릭). 
...
3. 일단 ChangeURL 브랜치에 있습니다. 대괄호로 분기하기 위해 만든 최근 커밋을 볼 수 있어야합니다. 
