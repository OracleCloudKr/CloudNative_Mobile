...
### 소개 ###
이 랩은 APAC 클라우드 테스트 드라이브의 일부로, 모든 네이티브 클라우드 및 모바일 구성 요소를 테스트하는 최종 Lab입니다. 이 섹션에서는 모바일 클라우드 서비스 푸시 알림 API를 통해 모바일과 상호 작용하고 워크샵 시나리오를 통해 테스트하는 방법에 대해 설명합니다. 
...
- 오늘 구축 된 모든 것에 대한 엔드 투 엔드 테스트 

**Lab 가정**
+ 첫 번째 역할은 &quot;응용 프로그램 설계자&quot;또는 &quot;개발자&quot;로, 코드 변경을 통해 모바일 응용 프로그램을 만듭니다. 
...
- 전통적인 모노리스 Java EE 애플리케이션을 클라우드로 `Lift-and-Shift`
- 클라우드 네이티브 `여러 언어(polyglot)`를 지원하는 마이크로 서비스 구축 
...
- 이전에 Java Apps 및 Microservices 랩에서 사용 한 Bracket

- Google 계정이 있는 Android OS 기기 (휴대 전화 또는 태블릿). 그렇지 않은 경우 강사에게 문의하십시오. 

# Lab 연습 : # 


## 501 : JEE 응용 프로그램에서 모바일 클라우드 서비스로 푸시 알림 전송을 위한 소스 코드 업데이트 ##
